...
export let iosWhatsappData = {
  ...
  dataLinks: [
    ...
    },
    {
      ...
      link:
        'https://www.dhimankamal.com/2022/11/ios-16-whatsapp-for-android-v945.html'
    },
    {
  ...
  dataLinks: [
    {
      ...
      link:
        'https://www.dhimankamal.com/2022/08/ios-snapchat-for-android-v1192.html'
    },
    {
      title: 'iOS Snapchat (v 11.86)',
      link:
        'https://www.dhimankamal.com/2022/06/ios-16-snapchat-for-android.html'
    },
    {
      title: 'iOS Snapchat (v 11.50)',
      link:
        'https://www.dhimankamal.com/2021/11/this-way-you-can-install-ios-snapchat.html'
    }
  ],
  tags:
    'Dhiman Kamal,iOS Snapchat For Android,iPhone Snapchat For Android,iOS Snapchat On Android,iPhone 13 Snapchat For Android,iOS 15 Theme For Snapchat,iOS Snapchat,iOS Snapchat New Update,iPhone Snapchat,Snapchat Update,Snapchat Hidden Features'
}
  ...
  dataLinks: [
    {
      ...
      link:
        'https://www.dhimankamal.com/2022/02/ios-fonts-and-emojis-together-in.html'
    },
...
export const instaFlowData = {
  ...
  dataLinks: [
    ...
    },
    {
      title: 'Insta Flow v8',
      link:
        'https://www.dhimankamal.com/2022/09/this-way-you-can-install-ios-instagram.html'
    }
  ],
  tags:
    'Dhiman Kamal,iOS instagram For Android,iPhone instagram For Android,iOS instagram On Android,iPhone 13 instagram For Android,iOS 15 Theme For Instagram,iOS Instagram,iOS instagram New Update,iPhone instagram,instagram Update,instagram Hidden Features'
  ...
  dataLinks: [
    {
      title: 'iGram v17',
      link:
        'https://www.dhimankamal.com/2023/01/ios-instagram-for-android-v17.html'
    },
    {
      title: 'iGram v16',
      link:
        'https://www.dhimankamal.com/2022/07/ios-instagram-for-android-v16.html'
    },
    {
      title: 'iGram v15',
      link:
        'https://www.dhimankamal.com/2021/10/ios-15-instagram-for-android-new-update.html'
    }
  ],
  addons: [
    {
      title: 'Timer (.GIF)',
      link:
        'https://www.dhimankamal.com/2021/08/how-to-share-instagram-reels-like.html'
    },
    {
      title: 'Edges (Zip File)',
      link:
        'https://www.dhimankamal.com/2021/07/get-ios-instagram-on-any-android-new.html'
    }
  ],
  tags:
    'Dhiman Kamal,iOS instagram For Android,iPhone instagram For Android,iOS instagram On Android,iPhone 13 instagram For Android,iOS 15 Theme For Instagram,iOS Instagram,iOS instagram New Update,iPhone instagram,instagram Update,instagram Hidden Features'
